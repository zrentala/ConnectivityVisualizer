...
class vtkAddMembershipArray(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    input_values:'getset_descriptor'
...
class vtkAdjacencyMatrixToEdgeTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    minimum_count:'getset_descriptor'
    minimum_threshold:'getset_descriptor'
    source_dimension:'getset_descriptor'
    value_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkCollapseVerticesByArray(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    allow_self_loops:'getset_descriptor'
    count_edges_collapsed:'getset_descriptor'
    count_vertices_collapsed:'getset_descriptor'
    edges_collapsed_array:'getset_descriptor'
    vertex_array:'getset_descriptor'
    vertices_collapsed_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkDotProductSimilarity(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    first_second:'getset_descriptor'
    lower_diagonal:'getset_descriptor'
    maximum_count:'getset_descriptor'
    minimum_count:'getset_descriptor'
    minimum_threshold:'getset_descriptor'
    second_first:'getset_descriptor'
    upper_diagonal:'getset_descriptor'
...
class vtkExpandSelectedGraph(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    bfs_distance:'getset_descriptor'
    domain:'getset_descriptor'
    graph_connection:'getset_descriptor'
    include_shortest_paths:'getset_descriptor'
    use_domain:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkExtractSelectedGraph(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    annotation_layers_connection:'getset_descriptor'
    remove_isolated_vertices:'getset_descriptor'
    selection_connection:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def FillInputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
...
class vtkGraphHierarchicalBundleEdges(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    ...
    direct_mapping:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkGroupLeafVertices(vtkmodules.vtkCommonExecutionModel.vtkTreeAlgorithm):
    group_domain:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkKCoreDecomposition(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    check_input_graph:'getset_descriptor'
    output_array_name:'getset_descriptor'
    use_in_degree_neighbors:'getset_descriptor'
    use_out_degree_neighbors:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkMergeColumns(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    merged_column_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkMergeGraphs(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    edge_window:'getset_descriptor'
    edge_window_array_name:'getset_descriptor'
    use_edge_window:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkMergeTables(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    first_table_prefix:'getset_descriptor'
    merge_columns_by_name:'getset_descriptor'
    prefix_all_but_merged:'getset_descriptor'
    second_table_prefix:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkNetworkHierarchy(vtkmodules.vtkCommonExecutionModel.vtkTreeAlgorithm):
    ip_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkPruneTreeFilter(vtkmodules.vtkCommonExecutionModel.vtkTreeAlgorithm):
    parent_vertex:'getset_descriptor'
    should_prune_parent_vertex:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkRandomGraphSource(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    allow_parallel_edges:'getset_descriptor'
    allow_self_loops:'getset_descriptor'
    directed:'getset_descriptor'
    edge_pedigree_id_array_name:'getset_descriptor'
    edge_probability:'getset_descriptor'
    edge_weight_array_name:'getset_descriptor'
    generate_pedigree_ids:'getset_descriptor'
    include_edge_weights:'getset_descriptor'
    number_of_edges:'getset_descriptor'
    number_of_edges_max_value:'getset_descriptor'
    number_of_edges_min_value:'getset_descriptor'
    number_of_vertices:'getset_descriptor'
    number_of_vertices_max_value:'getset_descriptor'
    number_of_vertices_min_value:'getset_descriptor'
    seed:'getset_descriptor'
    start_with_tree:'getset_descriptor'
    use_edge_probability:'getset_descriptor'
    vertex_pedigree_id_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkReduceTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    MEDIAN:int
    MODE:int
    index_column:'getset_descriptor'
    non_numerical_reduction_method:'getset_descriptor'
    numerical_reduction_method:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkSparseArrayToTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    value_column:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkStringToCategory(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    category_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkStringToNumeric(vtkmodules.vtkCommonExecutionModel.vtkDataObjectAlgorithm):
    convert_cell_data:'getset_descriptor'
    convert_edge_data:'getset_descriptor'
    convert_field_data:'getset_descriptor'
    convert_point_data:'getset_descriptor'
    convert_row_data:'getset_descriptor'
    convert_vertex_data:'getset_descriptor'
    default_double_value:'getset_descriptor'
    default_integer_value:'getset_descriptor'
    force_double:'getset_descriptor'
    trim_whitespace_prior_to_numeric_conversion:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkTableToGraph(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    directed:'getset_descriptor'
    link_graph:'getset_descriptor'
    m_time:'getset_descriptor'
    vertex_table_connection:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkTableToSparseArray(vtkmodules.vtkCommonExecutionModel.vtkArrayDataAlgorithm):
    output_extents:'getset_descriptor'
    value_column:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkThresholdTable(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    ACCEPT_OUTSIDE:int
    max_value:'getset_descriptor'
    min_value:'getset_descriptor'
...
class vtkTransferAttributes(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    default_value:'getset_descriptor'
    direct_mapping:'getset_descriptor'
    source_array_name:'getset_descriptor'
    source_field_type:'getset_descriptor'
    target_array_name:'getset_descriptor'
    target_field_type:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def DirectMappingOff(self) -> None: ...
    def DirectMappingOn(self) -> None: ...
    def FillInputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
...
class vtkTreeDifferenceFilter(vtkmodules.vtkCommonExecutionModel.vtkGraphAlgorithm):
    comparison_array_is_vertex_data:'getset_descriptor'
    comparison_array_name:'getset_descriptor'
    id_array_name:'getset_descriptor'
    output_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkTreeFieldAggregator(vtkmodules.vtkCommonExecutionModel.vtkTreeAlgorithm):
    field:'getset_descriptor'
    leaf_vertex_unit_size:'getset_descriptor'
...
class vtkWordCloud(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    background_color_name:'getset_descriptor'
    bw_mask:'getset_descriptor'
    color_scheme_name:'getset_descriptor'
    dpi:'getset_descriptor'
    file_name:'getset_descriptor'
    font_file_name:'getset_descriptor'
    font_multiplier:'getset_descriptor'
    gap:'getset_descriptor'
    kept_words:'getset_descriptor'
    mask_color_name:'getset_descriptor'
    mask_file_name:'getset_descriptor'
    max_font_size:'getset_descriptor'
    min_font_size:'getset_descriptor'
    min_frequency:'getset_descriptor'
    orientations:'getset_descriptor'
    skipped_words:'getset_descriptor'
    stop_list_file_name:'getset_descriptor'
    stopped_words:'getset_descriptor'
    title:'getset_descriptor'
    word_color_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
