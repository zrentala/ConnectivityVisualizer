...
class vtkDynamic2DLabelMapper(vtkLabeledDataMapper):
    label_height_padding:'getset_descriptor'
    label_width_padding:'getset_descriptor'
    priority_array_name:'getset_descriptor'
    reverse_priority:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkLabelRenderStrategy(vtkmodules.vtkCommonCore.vtkObject):
    default_text_property:'getset_descriptor'
...
class vtkLabelHierarchy(vtkmodules.vtkCommonDataModel.vtkPointSet):
    ...
    QUEUE:'IteratorType'
    bounded_sizes:'getset_descriptor'
    center_pts:'getset_descriptor'
    coincident_points:'getset_descriptor'
    icon_indices:'getset_descriptor'
    labels:'getset_descriptor'
    max_cell_size:'getset_descriptor'
    maximum_depth:'getset_descriptor'
    number_of_cells:'getset_descriptor'
    orientations:'getset_descriptor'
    points:'getset_descriptor'
    priorities:'getset_descriptor'
    sizes:'getset_descriptor'
    target_label_count:'getset_descriptor'
...
class vtkLabelHierarchyIterator(vtkmodules.vtkCommonCore.vtkObject):
    all_bounds:'getset_descriptor'
    hierarchy:'getset_descriptor'
    label:'getset_descriptor'
    label_id:'getset_descriptor'
    orientation:'getset_descriptor'
    traversed_bounds:'getset_descriptor'
...
class vtkLabelPlacementMapper(vtkmodules.vtkRenderingCore.vtkMapper2D):
    ...
    anchor_transform:'getset_descriptor'
    background_color:'getset_descriptor'
    background_opacity:'getset_descriptor'
    generate_perturbed_label_spokes:'getset_descriptor'
    iterator_type:'getset_descriptor'
    margin:'getset_descriptor'
    maximum_label_fraction:'getset_descriptor'
    output_traversed_bounds:'getset_descriptor'
    place_all_labels:'getset_descriptor'
    positions_as_normals:'getset_descriptor'
    render_strategy:'getset_descriptor'
...
class vtkLabelSizeCalculator(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    label_size_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetDPI(self) -> int: ...
...
class vtkLabeledTreeMapDataMapper(vtkLabeledDataMapper):
    child_motion:'getset_descriptor'
    clip_text_mode:'getset_descriptor'
    dynamic_level:'getset_descriptor'
    font_size_range:'getset_descriptor'
    input_tree:'getset_descriptor'
    level_range:'getset_descriptor'
...
class vtkPointSetToLabelHierarchy(vtkLabelHierarchyAlgorithm):
    bounded_size_array_name:'getset_descriptor'
    icon_index_array_name:'getset_descriptor'
    label_array_name:'getset_descriptor'
    maximum_depth:'getset_descriptor'
    orientation_array_name:'getset_descriptor'
    priority_array_name:'getset_descriptor'
