...
class vtkArrowSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    arrow_origin:'getset_descriptor'
    invert:'getset_descriptor'
    shaft_radius:'getset_descriptor'
    shaft_resolution:'getset_descriptor'
    tip_length:'getset_descriptor'
    tip_radius:'getset_descriptor'
    tip_resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkButtonSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    center:'getset_descriptor'
    shoulder_texture_coordinate:'getset_descriptor'
    texture_dimensions:'getset_descriptor'
    texture_style:'getset_descriptor'
    two_sided:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCenter(self) -> Tuple[float, float, float]: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
...
class vtkCellTypeSource(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    blocks_dimensions:'getset_descriptor'
    cell_dimension:'getset_descriptor'
    cell_order:'getset_descriptor'
    cell_type:'getset_descriptor'
    complete_quadratic_simplicial_elements:'getset_descriptor'
    output_precision:'getset_descriptor'
    polynomial_field_order:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkCubeSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    center:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    x_length:'getset_descriptor'
    y_length:'getset_descriptor'
    z_length:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkCylinderSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    capping:'getset_descriptor'
    capsule_cap:'getset_descriptor'
    center:'getset_descriptor'
    height:'getset_descriptor'
    lat_long_tessellation:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    radius:'getset_descriptor'
    resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkDiagonalMatrixSource(vtkmodules.vtkCommonExecutionModel.vtkArrayDataAlgorithm):
    ...
    column_label:'getset_descriptor'
    diagonal:'getset_descriptor'
    extents:'getset_descriptor'
    row_label:'getset_descriptor'
    sub_diagonal:'getset_descriptor'
    super_diagonal:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkDiskSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    center:'getset_descriptor'
    circumferential_resolution:'getset_descriptor'
    inner_radius:'getset_descriptor'
    normal:'getset_descriptor'
    outer_radius:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    radial_resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCenter(self) -> Tuple[float, float, float]: ...
...
class vtkEllipseArcSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    major_radius_vector:'getset_descriptor'
    normal:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    ratio:'getset_descriptor'
    resolution:'getset_descriptor'
    segment_angle:'getset_descriptor'
...
class vtkEllipticalButtonSource(vtkButtonSource):
    ...
    height:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    radial_ratio:'getset_descriptor'
    shoulder_resolution:'getset_descriptor'
    texture_resolution:'getset_descriptor'
...
class vtkFrustumSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    lines_length:'getset_descriptor'
    m_time:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    planes:'getset_descriptor'
    show_lines:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkGlyphSource2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    cross:'getset_descriptor'
    dash:'getset_descriptor'
    double_pointed:'getset_descriptor'
    filled:'getset_descriptor'
    glyph_type:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    point_inwards:'getset_descriptor'
    resolution:'getset_descriptor'
    rotation_angle:'getset_descriptor'
    scale:'getset_descriptor'
    scale2:'getset_descriptor'
    tip_length:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkGoldenBallSource(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    center:'getset_descriptor'
    generate_normals:'getset_descriptor'
    include_center_point:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    radius:'getset_descriptor'
    resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetIncludeCenterPoint(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOutputPointsPrecision(self) -> int: ...
    ...
    def GetResolutionMaxValue(self) -> int: ...
    def GetResolutionMinValue(self) -> int: ...
    def IncludeCenterPointOff(self) -> None: ...
    def IncludeCenterPointOn(self) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkGoldenBallSource': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkGoldenBallSource': ...
    @overload
    def SetCenter(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetCenter(self, _arg:Sequence[float]) -> None: ...
    def SetGenerateNormals(self, _arg:int) -> None: ...
    def SetIncludeCenterPoint(self, _arg:int) -> None: ...
    def SetOutputPointsPrecision(self, _arg:int) -> None: ...
    def SetRadius(self, _arg:float) -> None: ...
    def SetResolution(self, _arg:int) -> None: ...

class vtkGraphToPolyData(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    edge_glyph_output:'getset_descriptor'
    edge_glyph_position:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkHyperTreeGridPreConfiguredSource(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    custom_architecture:'getset_descriptor'
    custom_depth:'getset_descriptor'
    custom_dim:'getset_descriptor'
    custom_extent:'getset_descriptor'
    custom_factor:'getset_descriptor'
    custom_subdivisions:'getset_descriptor'
    htg_mode:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkHyperTreeGridSource(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    descriptor:'getset_descriptor'
    descriptor_bits:'getset_descriptor'
    dimensions:'getset_descriptor'
    generate_interface_fields:'getset_descriptor'
    grid_scale:'getset_descriptor'
    level_zero_material_index:'getset_descriptor'
    m_time:'getset_descriptor'
    mask:'getset_descriptor'
    mask_bits:'getset_descriptor'
    max_depth:'getset_descriptor'
    ...
    use_descriptor:'getset_descriptor'
    use_mask:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkLineSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    resolution:'getset_descriptor'
    use_regular_refinement:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkParametricFunctionSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    generate_normals:'getset_descriptor'
    generate_texture_coordinates:'getset_descriptor'
    m_time:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    parametric_function:'getset_descriptor'
    scalar_mode:'getset_descriptor'
    u_resolution:'getset_descriptor'
    v_resolution:'getset_descriptor'
    w_resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GenerateNormalsOff(self) -> None: ...
    def GenerateNormalsOn(self) -> None: ...
...
class vtkPartitionedDataSetCollectionSource(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetCollectionAlgorithm):
    number_of_shapes:'getset_descriptor'
    number_of_shapes_max_value:'getset_descriptor'
    number_of_shapes_min_value:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkPartitionedDataSetSource(vtkmodules.vtkCommonExecutionModel.vtkPartitionedDataSetAlgorithm):
    ...
    number_of_partitions_max_value:'getset_descriptor'
    number_of_partitions_min_value:'getset_descriptor'
    parametric_function:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkPlaneSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    point2:'getset_descriptor'
    resolution:'getset_descriptor'
    x_resolution:'getset_descriptor'
    y_resolution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkPointSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    output_points_precision:'getset_descriptor'
    radius:'getset_descriptor'
    random_sequence:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCenter(self) -> Tuple[float, float, float]: ...
...
class vtkRandomHyperTreeGridSource(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    actual_masked_cell_fraction:'getset_descriptor'
    dimensions:'getset_descriptor'
    masked_fraction:'getset_descriptor'
    max_depth:'getset_descriptor'
    output_bounds:'getset_descriptor'
    seed:'getset_descriptor'
    split_fraction:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetActualMaskedCellFraction(self) -> float: ...
    def GetDimensions(self) -> Tuple[int, int, int]: ...
    def GetMaskedFraction(self) -> float: ...
    def GetMaskedFractionMaxValue(self) -> float: ...
    def GetMaskedFractionMinValue(self) -> float: ...
    def GetMaxDepth(self) -> int: ...
    ...
    def SetMaskedFraction(self, _arg:float) -> None: ...
...
class vtkRectangularButtonSource(vtkButtonSource):
    box_ratio:'getset_descriptor'
    depth:'getset_descriptor'
    height:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    texture_height_ratio:'getset_descriptor'
    texture_ratio:'getset_descriptor'
    width:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkRegularPolygonSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    center:'getset_descriptor'
    generate_polygon:'getset_descriptor'
    generate_polyline:'getset_descriptor'
    normal:'getset_descriptor'
...
class vtkSelectionSource(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    composite_index:'getset_descriptor'
    ...
    field_type_option:'getset_descriptor'
    frustum:'getset_descriptor'
    hierarchical_index:'getset_descriptor'
    hierarchical_level:'getset_descriptor'
    inverse:'getset_descriptor'
    node_name:'getset_descriptor'
    ...
    remove_intermediate_layers:'getset_descriptor'
    remove_seed:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @overload
...
class vtkSpatioTemporalHarmonicsSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkSpatioTemporalHarmonicsSource': ...
    def ResetHarmonics(self) -> None: ...
    def ResetTimeStepValues(self) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkSpatioTemporalHarmonicsSource': ...
    @overload
...
class vtkSphereSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    center:'getset_descriptor'
    end_phi:'getset_descriptor'
    end_theta:'getset_descriptor'
    generate_normals:'getset_descriptor'
    lat_long_tessellation:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    phi_resolution:'getset_descriptor'
    radius:'getset_descriptor'
    start_phi:'getset_descriptor'
    start_theta:'getset_descriptor'
...
class vtkSuperquadricSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    axis_of_symmetry:'getset_descriptor'
    center:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    phi_resolution:'getset_descriptor'
...
class vtkTessellatedBoxSource(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    bounds:'getset_descriptor'
    duplicate_shared_points:'getset_descriptor'
    level:'getset_descriptor'
    output_points_precision:'getset_descriptor'
    quads:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
