...
class vtkXMLReader(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    column_array_selection:'getset_descriptor'
...
class vtkRTXMLPolyDataReader(vtkXMLPolyDataReader):
    ...
    next_file_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkXMLCompositeDataReader(vtkXMLReader):
    ...
    file_name:'getset_descriptor'
    output:'getset_descriptor'
    piece_distribution:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkXMLWriterBase(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    compressor:'getset_descriptor'
    compressor_type:'getset_descriptor'
    data_mode:'getset_descriptor'
    default_file_extension:'getset_descriptor'
    encode_appended_data:'getset_descriptor'
    file_name:'getset_descriptor'
    header_type:'getset_descriptor'
    id_type:'getset_descriptor'
    output_string:'getset_descriptor'
    write_time_value:'getset_descriptor'
    ...
    def GetWriteTimeValue(self) -> bool: ...
    ...
    def SetWriteTimeValue(self, _arg:bool) -> None: ...
    def SetWriteToOutputString(self, _arg:bool) -> None: ...
    def Write(self) -> int: ...
    def WriteTimeValueOff(self) -> None: ...
    def WriteTimeValueOn(self) -> None: ...
...
class vtkXMLCompositeDataWriter(vtkXMLWriter):
    ...
    write_meta_file:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetDefaultFileExtension(self) -> str: ...
...
class vtkXMLFileReadTester(vtkmodules.vtkIOXMLParser.vtkXMLParser):
    file_data_type:'getset_descriptor'
...
class vtkXMLGenericDataObjectReader(vtkXMLDataReader):
    hierarchical_box_data_set_output:'getset_descriptor'
    image_data_output:'getset_descriptor'
    multi_block_data_set_output:'getset_descriptor'
    number_of_cells:'getset_descriptor'
    number_of_points:'getset_descriptor'
    output:'getset_descriptor'
    overlapping_amr_output:'getset_descriptor'
    ...
    def GetOverlappingAMROutput(self) -> 'vtkOverlappingAMR': ...
...
class vtkXMLHierarchicalBoxDataFileConverter(vtkmodules.vtkCommonCore.vtkObject):
    input_file_name:'getset_descriptor'
    output_file_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkXMLUniformGridAMRReader(vtkXMLCompositeDataReader):
    maximum_levels_to_read_by_default:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkXMLHyperTreeGridReader(vtkXMLReader):
    coordinates_bounding_box:'getset_descriptor'
    fixed_level:'getset_descriptor'
    indices_bounding_box:'getset_descriptor'
    number_of_pieces:'getset_descriptor'
    number_of_points:'getset_descriptor'
    output:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkXMLHyperTreeGridWriter(vtkXMLWriter):
    data_set_major_version:'getset_descriptor'
    data_set_minor_version:'getset_descriptor'
    default_file_extension:'getset_descriptor'
    input:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetDefaultFileExtension(self) -> str: ...
...
class vtkXMLStructuredDataReader(vtkXMLDataReader):
    number_of_cells:'getset_descriptor'
    number_of_points:'getset_descriptor'
    whole_slices:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def CopyOutputInformation(self, outInfo:'vtkInformation', port:int) -> None: ...
    def GetNumberOfCells(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
...
class vtkXMLPTableReader(vtkXMLPDataObjectReader):
    column_selection:'getset_descriptor'
    number_of_column_arrays:'getset_descriptor'
    output:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def CopyOutputInformation(self, outInfo:'vtkInformation', port:int) -> None: ...
