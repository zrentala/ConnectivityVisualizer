...
class vtkHyperTreeGridGenerateFieldStrategy(vtkmodules.vtkCommonCore.vtkObject):
    and_finalize_array:'getset_descriptor'
    array_name:'getset_descriptor'
    array_type:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Compute(self, __a:'vtkHyperTreeGridNonOrientedGeometryCursor') -> None: ...
    def GetAndFinalizeArray(self) -> 'vtkDataArray': ...
    def GetArrayName(self) -> str: ...
    def GetArrayType(self) -> vtkDataObject.AttributeTypes: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def Initialize(self, __a:'vtkHyperTreeGrid') -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridGenerateFieldStrategy': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridGenerateFieldStrategy': ...
    def SetArrayName(self, arrayName:str) -> None: ...
    def SetArrayType(self, arrayType:vtkDataObject.AttributeTypes) -> None: ...

class vtkHyperTreeGridCellCenterStrategy(vtkHyperTreeGridGenerateFieldStrategy):
    and_finalize_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Compute(self, cursor:'vtkHyperTreeGridNonOrientedGeometryCursor') -> None: ...
    def GetAndFinalizeArray(self) -> 'vtkDataArray': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def Initialize(self, inputHTG:'vtkHyperTreeGrid') -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridCellCenterStrategy': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridCellCenterStrategy': ...
...
class vtkHyperTreeGridCellSizeStrategy(vtkHyperTreeGridGenerateFieldStrategy):
    and_finalize_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Compute(self, cursor:'vtkHyperTreeGridNonOrientedGeometryCursor') -> None: ...
    def GetAndFinalizeArray(self) -> 'vtkDataArray': ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridCellSizeStrategy': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridCellSizeStrategy': ...
...
class vtkHyperTreeGridGenerateFields(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    cell_center_array_name:'getset_descriptor'
    cell_size_array_name:'getset_descriptor'
    compute_cell_center_array:'getset_descriptor'
    compute_cell_size_array:'getset_descriptor'
    compute_total_visible_volume_array:'getset_descriptor'
    compute_valid_cell_array:'getset_descriptor'
    total_visible_volume_array_name:'getset_descriptor'
    valid_cell_array_name:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def ComputeCellCenterArrayOff(self) -> None: ...
    def ComputeCellCenterArrayOn(self) -> None: ...
    def ComputeCellSizeArrayOff(self) -> None: ...
    def ComputeCellSizeArrayOn(self) -> None: ...
    def ComputeTotalVisibleVolumeArrayOff(self) -> None: ...
    def ComputeTotalVisibleVolumeArrayOn(self) -> None: ...
    def ComputeValidCellArrayOff(self) -> None: ...
    def ComputeValidCellArrayOn(self) -> None: ...
    def GetCellCenterArrayName(self) -> str: ...
    def GetCellSizeArrayName(self) -> str: ...
    def GetComputeCellCenterArray(self) -> bool: ...
    def GetComputeCellSizeArray(self) -> bool: ...
    def GetComputeTotalVisibleVolumeArray(self) -> bool: ...
    def GetComputeValidCellArray(self) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTotalVisibleVolumeArrayName(self) -> str: ...
    def GetValidCellArrayName(self) -> str: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridGenerateFields': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridGenerateFields': ...
    def SetCellCenterArrayName(self, name:str) -> None: ...
    def SetCellSizeArrayName(self, name:str) -> None: ...
    def SetComputeCellCenterArray(self, enable:bool) -> None: ...
    def SetComputeCellSizeArray(self, enable:bool) -> None: ...
    def SetComputeTotalVisibleVolumeArray(self, enable:bool) -> None: ...
    def SetComputeValidCellArray(self, enable:bool) -> None: ...
    def SetTotalVisibleVolumeArrayName(self, name:str) -> None: ...
    def SetValidCellArrayName(self, name:str) -> None: ...
...
class vtkHyperTreeGridGeometry(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    def SetFillMaterial(self, _arg:bool) -> None: ...
...
class vtkHyperTreeGridTotalVisibleVolumeStrategy(vtkHyperTreeGridGenerateFieldStrategy):
    and_finalize_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Compute(self, __a:'vtkHyperTreeGridNonOrientedGeometryCursor') -> None: ...
    def GetAndFinalizeArray(self) -> 'vtkDataArray': ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridTotalVisibleVolumeStrategy': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridTotalVisibleVolumeStrategy': ...

class vtkHyperTreeGridValidCellStrategy(vtkHyperTreeGridGenerateFieldStrategy):
    and_finalize_array:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def Compute(self, cursor:'vtkHyperTreeGridNonOrientedGeometryCursor') -> None: ...
    def GetAndFinalizeArray(self) -> 'vtkDataArray': ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkHyperTreeGridValidCellStrategy': ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkHyperTreeGridValidCellStrategy': ...

class vtkHyperTreeGridVisibleLeavesSize(vtkHyperTreeGridGenerateFields):
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
