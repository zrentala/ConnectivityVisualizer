...
#         self._scale_range_cache: dict[int, Tuple[float, Tuple[float, float]]] = {}
#         self._edge_index_cache: dict[int, List[Tuple[int, int]]] = {}
...
#         return scale, (data_min, data_max)
...
#         scale, (data_min, data_max) = self._get_scale_and_range(C)
