...
class vtkExporter(vtkmodules.vtkCommonCore.vtkObject):
    active_renderer:'getset_descriptor'
...
class vtkGLTFExporter(vtkExporter):
    ...
    inline_data:'getset_descriptor'
    save_batch_id:'getset_descriptor'
    save_na_n_values:'getset_descriptor'
    save_normal:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    ...
    def GetSaveNaNValues(self) -> bool: ...
    ...
    def SaveNaNValuesOff(self) -> None: ...
    def SaveNaNValuesOn(self) -> None: ...
    ...
    def SetSaveNaNValues(self, _arg:bool) -> None: ...
...
class vtkJSONRenderWindowExporter(vtkExporter):
    archiver:'getset_descriptor'
    compact_output:'getset_descriptor'
...
class vtkJSONSceneExporter(vtkExporter):
    ...
    file_name:'getset_descriptor'
    point_array_selection:'getset_descriptor'
    poly_lo_ds_base_size:'getset_descriptor'
    poly_lo_ds_base_url:'getset_descriptor'
    texture_lo_ds_base_size:'getset_descriptor'
    texture_lo_ds_base_url:'getset_descriptor'
    write_poly_lo_ds:'getset_descriptor'
    write_texture_lo_ds:'getset_descriptor'
    write_textures:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetCellArraySelection(self) -> 'vtkDataArraySelection': ...
    def GetFileName(self) -> str: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
...
class vtkOBJExporter(vtkExporter):
    ...
    mtl_file_comment:'getset_descriptor'
    obj_file_comment:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkRIBExporter(vtkExporter):
    ...
    export_arrays:'getset_descriptor'
    file_prefix:'getset_descriptor'
    pixel_samples:'getset_descriptor'
    size:'getset_descriptor'
    texture_prefix:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkRIBProperty(vtkmodules.vtkRenderingCore.vtkProperty):
    ...
    displacement_shader:'getset_descriptor'
    displacement_shader_parameters:'getset_descriptor'
    parameters:'getset_descriptor'
    surface_shader:'getset_descriptor'
    surface_shader_parameters:'getset_descriptor'
    surface_shader_uses_default_parameters:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
